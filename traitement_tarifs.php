			...
			<p>
				...
				<select name="tarif" id="tarif">
					...
					<optgroup label="TARIFS REGULIERS">
						...
						<option value="BORBLE">BORDEAUX BLENDS (BORBLE, Universel)</option>
						...
						<option value="TERTRA">TERROIRS & TRADITIONS (AMELIE GRANT - TERTRA, Universel !)</option>
					...
					<optgroup label="TARIFS EXPORT OFFICIEUX">
						...
						<option value="BALOFF">BALLANDE ET MENERET EXPORT OFFICIEUX (BALOFF, xlsx)</option>
					...
					<optgroup label="ETRANGERS ET HORS BORDEAUX">
						...
						<option value="CAVCAR">CAVE CARRIERE (CAVCAR) ou CARRIERE & ASSOCIES (CARASS), csv)</option>
						...
						<option value="CAVTOU">LE CAVEAU DE LA TOUR (CAVTOU, Universel)</option>
